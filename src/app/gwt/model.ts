...
export enum ActionType {
  ...
  MOVE_ENGINE_1_BACKWARDS_TO_REMOVE_2_CARDS_AND_GAIN_2_DOLLARS = 'MOVE_ENGINE_1_BACKWARDS_TO_REMOVE_2_CARDS_AND_GAIN_2_DOLLARS',
  ...
  REMOVE_CARD_AND_GAIN_1_DOLLAR = 'REMOVE_CARD_AND_GAIN_1_DOLLAR',
